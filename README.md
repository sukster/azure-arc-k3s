...
Follow the instructions to send control plane audit logs to Microsoft Sentinel: https://learn.microsoft.com/en-us/azure/aks/aksarc/kubernetes-monitor-audit-events
